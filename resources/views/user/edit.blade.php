                    ...
                    <form action="/crew" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('firstname') $crew->firstname }}" required autocomplete="firstname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('lastname') $crew->lastname}}" required autocomplete="lastname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('middlename') $crew->middlename }}" required autocomplete="middlename" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('email') $crew->email}}" required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('address') $crew->address}}" required autocomplete="address" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('education') $crew->education}}" required autocomplete="education" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('contactdetails') $crew->contactdetails}}" required autocomplete="contactdetails" autofocus>
