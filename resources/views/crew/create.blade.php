...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Crew Details') }}</div>

                <div class="card-body">
                    <form action="/crew/insert" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contactdetails" type="text" class="form-control @error('contactdetails') is-invalid @enderror" name="contactdetails" value="{{ old('contactdetails') }}" required autocomplete="contactdetails" autofocus>
